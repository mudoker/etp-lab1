  ...
  return (
    <div className="bg-background text-foreground flex min-h-screen flex-col">
      ...
      <main className="container mx-auto flex-1 px-4 py-12">
        ...
        <section className={cn('mt-24 grid grid-cols-1 gap-8 md:grid-cols-3')}>
          {['Feature One', 'Feature Two', 'Feature Three'].map((feature) => (
            <div key={feature} className="rounded-lg border p-6 shadow-sm">
              <h3 className="mb-2 text-lg font-medium">{feature}</h3>
              <p className="text-muted-foreground">
                A brief description of this amazing feature and how it can help
                users.
              </p>
            </div>
          ))}
